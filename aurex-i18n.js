...
(function() {
  ...
  var T = {
    ...
    // === MODAL PLANES ===
    elegir_plan: { es: 'Elegir tu plan', en: 'Choose your plan' },
    planes_incluyen_pulse: { es: 'Todos los planes incluyen AUREX Pulse', en: 'All plans include AUREX Pulse' },
    plan_free_subtitle: { es: 'Para empezar a invertir mejor', en: 'To start investing better' },
    plan_free_f1: { es: '5 activos en portfolio', en: '5 assets in portfolio' },
    plan_free_f2: { es: '3 señales IA por día', en: '3 AI signals per day' },
    plan_free_f3: { es: 'Mercados en tiempo real', en: 'Real-time markets' },
    plan_free_f4_pulse: { es: 'AUREX Pulse', en: 'AUREX Pulse' },
    plan_free_f4_detail: { es: '(indicador, sin detalles)', en: '(indicator, no details)' },
    plan_free_f5: { es: 'Alertas push al celular', en: 'Push alerts to phone' },
    plan_free_f6: { es: 'Variables y explicación de Pulse', en: 'Pulse variables and explanation' },
    plan_free_f7: { es: 'Historial de señales', en: 'Signal history' },
    plan_free_f8: { es: 'Sin publicidad', en: 'Ad-free' },
    ver_plan_pro: { es: 'Ver plan PRO →', en: 'View PRO plan →' },
    mas_popular: { es: 'MÁS POPULAR', en: 'MOST POPULAR' },
    por_mes: { es: '/mes', en: '/mo' },
    pro_anual_desc: { es: '$7,79/mes si pagás anual', en: '$7.79/mo if paid annually' },
    plan_pro_subtitle: { es: 'Para el inversor activo', en: 'For the active investor' },
    plan_pro_f1: { es: 'Activos ilimitados en portfolio', en: 'Unlimited assets in portfolio' },
    plan_pro_f2: { es: 'Señales IA ilimitadas + historial 30 días', en: 'Unlimited AI signals + 30-day history' },
    plan_pro_f3: { es: 'Alertas push al celular (precio, señal IA, variación)', en: 'Push alerts to phone (price, AI signal, variation)' },
    plan_pro_f4: { es: 'AUREX Pulse con variables y explicación básica', en: 'AUREX Pulse with variables and basic explanation' },
    plan_pro_f5: { es: 'Sin publicidad', en: 'Ad-free' },
    plan_pro_f6: { es: 'Exportar portfolio (Excel/PDF)', en: 'Export portfolio (Excel/PDF)' },
    plan_pro_f7: { es: 'Soporte prioritario por email', en: 'Priority email support' },
    plan_pro_f8: { es: 'Pulse explicación profunda + historial', en: 'Deep Pulse explanation + history' },
    plan_pro_f9: { es: 'Alertas SMS / WhatsApp', en: 'SMS / WhatsApp alerts' },
    pro_mensual_btn: { es: '🚀 PRO Mensual — $9,99/mes', en: '🚀 PRO Monthly — $9.99/mo' },
    pro_anual_btn: { es: '⭐ PRO Anual — $89,99/año', en: '⭐ PRO Annual — $89.99/yr' },
    ahorras_25: { es: '(ahorrás 25%)', en: '(save 25%)' },
    elite_anual_desc: { es: '$15,99/mes si pagás anual', en: '$15.99/mo if paid annually' },
    plan_elite_subtitle: { es: 'Para el inversor profesional', en: 'For the professional investor' },
    plan_elite_f1: { es: 'Todo lo incluido en PRO', en: 'Everything included in PRO' },
    plan_elite_f2: { es: 'AUREX Pulse completo: variables, explicación profunda e historial', en: 'Full AUREX Pulse: variables, deep explanation and history' },
    plan_elite_f3: { es: 'Señales IA con nivel de confianza y razón detallada', en: 'AI signals with confidence level and detailed reasoning' },
    plan_elite_f4: { es: 'Análisis técnico avanzado (RSI, MACD)', en: 'Advanced technical analysis (RSI, MACD)' },
    plan_elite_f5: { es: 'Alertas SMS / WhatsApp / Telegram', en: 'SMS / WhatsApp / Telegram alerts' },
    plan_elite_f6: { es: 'Acceso anticipado a funciones beta', en: 'Early access to beta features' },
    plan_elite_f7: { es: 'Soporte por chat en vivo', en: 'Live chat support' },
    plan_elite_f8: { es: 'API personal para integraciones', en: 'Personal API for integrations' },
    elite_mensual_btn: { es: '👑 ELITE Mensual — $19,99/mes', en: '👑 ELITE Monthly — $19.99/mo' },
    elite_anual_btn: { es: '⭐ ELITE Anual — $179,99/año', en: '⭐ ELITE Annual — $179.99/yr' },

    // === AVISO LEGAL POPUP ===
    aviso_legal_titulo: { es: '⚖️ AVISO LEGAL', en: '⚖️ LEGAL NOTICE' },
    aviso_legal_p1: { es: 'La información proporcionada por AUREX tiene carácter exclusivamente informativo y educativo. No constituye asesoramiento financiero, recomendación de inversión, ni oferta de compra o venta de ningún activo financiero.', en: 'The information provided by AUREX is exclusively informational and educational. It does not constitute financial advice, investment recommendation, or offer to buy or sell any financial asset.' },
    aviso_legal_p2: { es: 'Las señales, análisis e indicadores mostrados son generados por algoritmos automatizados y no deben interpretarse como garantía de resultados futuros. Invertir conlleva riesgos, incluida la posible pérdida del capital invertido.', en: 'The signals, analysis and indicators shown are generated by automated algorithms and should not be interpreted as a guarantee of future results. Investing involves risks, including the possible loss of invested capital.' },
    aviso_legal_p3: { es: 'Consulte siempre a un asesor financiero certificado antes de tomar decisiones de inversión.', en: 'Always consult a certified financial advisor before making investment decisions.' },
    aviso_legal_cerrar: { es: '✕ Cerrar', en: '✕ Close' }
  };
