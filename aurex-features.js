...
// === toggleEdit: modo ediciÃ³n con flechas â²â¼ ===
window._editMode=false;
...
function _renderThermoRisk(items){
  ...
  else if(pAlc >= 50) explanation = 'â La mayorÃ­a de tu cartera tiene momentum positivo segÃºn la IA.';
...
function _buildIADetail(s) {
  ...
  if(s.scores) {
    ...
    html += '<span style="font-size:10px"><span style="color:#3FB950;font-weight:700">â '+posVars.length+' alcistas</span><span style="color:#555;margin:0 5px">Â·</span><span style="color:#FF4444;font-weight:700">â '+negVars.length+' bajistas</span></span>';
    html += '</div>';
    // Positivas primero
