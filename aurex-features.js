...
window.wlShareList = function(){
  ...
  overlay.innerHTML='<div style="background:#1C1C1E;border-radius:16px 16px 0 0;padding:20px 20px 30px;width:100%;max-width:440px">'+
    ...
    '<a href="mailto:?subject=AUREX - Lista '+cl.name+'&body='+enc+'" style="width:90px;height:80px;background:#1A1200;border:1px solid #D4A01740;border-radius:12px;display:flex;flex-direction:column;align-items:center;justify-content:center;cursor:pointer;text-decoration:none"><span style="font-size:24px;margin-bottom:4px">📧</span><span style="font-size:11px;color:#D4A017;font-weight:600">Mail</span></a>'+
    '</div>'+
