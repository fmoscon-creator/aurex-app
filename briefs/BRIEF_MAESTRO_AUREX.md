...
| 🟠 **Rebrand Android → Cobrex** | 🟠 **PRÓXIMO FRENTE GRANDE** — unificar marca (Android v1.0.36 ya publicado hace semanas sigue "AUREX"). **TOTALMENTE INDEPENDIENTE de iOS** (otra tienda, no se cruza metadata). Ver §3.5 | Definir con Fernando cuándo arrancar (web ya hecha; **sin bloqueante de iOS**) | — |
