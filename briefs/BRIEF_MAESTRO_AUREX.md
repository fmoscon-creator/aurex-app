...
- **Pendiente Fase 2 (en orden):** registrar `@cobrexio` en 5 redes + LinkedIn empresa "Cobrex" → verificar contratos in-effect (Agreements/Tax/Banking) → **publicar app** (manual) → convergencia (Android+web→Cobrex + mail @cobrex.io).
