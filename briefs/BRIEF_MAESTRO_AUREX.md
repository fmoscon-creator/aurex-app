...
- ✅ **CONSOLIDADO v1** (coincidencias / diferencias / decisiones a consensuar / pendientes): `briefs/cro/CONSOLIDADO_CRO_v1.md`.
...
- ✅ **DECISIÓN Fernando 04-jun: las analytics (Firebase Analytics, ~8 eventos del funnel) entran SÍ O SÍ en el Build 39 iOS + el próximo build Android.** (Firebase ya integrado para push → es agregar módulo `/analytics`.)
- ⏳ **Pendiente (mañana, sin apurar, NADA se cambia):** precios por mercado (Code extrae precios reales en tiendas + geo-pricing; Escritorio benchmarks faltantes) · decisiones de producto a consensuar (SSO, mover paywall, onboarding que guíe la 1ª alerta).
