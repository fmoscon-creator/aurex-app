...
> **Última actualización:** 25-may-2026 AR — **🟢 iOS Build 35 "COBREX" ENVIADO a revisión de Apple (25/05 14:02 AR · submission `e0e7fb35-11a4-4c1d-854c-60a80c4799e6` · "Pendiente de revisión")**. Rebrand **"AurexLive" → "Cobrex"** SOLO iOS (nombre original acuñado, sin relación con aurex.ai/Beinex), tras el 3er rechazo 4.1c. Build 35 = textos Cobrex en 8 idiomas + **splash nativo COBREX** + onboarding RN + `CFBundleDisplayName=Cobrex` (v35) + 20 capturas (iPhone 6.5" 1242×2688 + iPad 13" 2048×2732). Android 36 sigue "AUREX" en producción (intacto). Ver **§1.f**. 🔴 **PENDIENTE Fernando: completar el FORMULARIO FISCAL en Play Console** (sino Google retiene impuestos sobre los pagos). ⚠️ **Google Search Console: nuevo error de indexación "No se ha encontrado (404)" (msg WNC-20237597)** en aurex.live — a revisar.
...
| 🤖 **Android Build 36 (v1.0.36)** | 🟢 **PUBLICADO en PRODUCCIÓN** + **IAP VALIDADO con compra REAL** (24-may: PRO Mensual USD 9.99 cobrado + cancelación, cuenta app.aurex). | **🔴 PENDIENTE (al 25-may): completar el FORMULARIO FISCAL en Play Console (W-8BEN, EEUU) — máx 30-may** (sino Google retiene impuestos sobre los pagos). Ver §3.6. #90 (futuro): nombre cuenta dev + edge-to-edge | Trámite Fernando |
...
- **🔴 PENDIENTE Fernando: completar el FORMULARIO FISCAL en Play Console (W-8BEN, EEUU)** — sin esto Google retiene impuestos sobre los pagos. Máx 30-may.

### ⚠️ Google Search Console — nuevo error de indexación (25-may)
- Llegó mail (message type **WNC-20237597**): páginas de **aurex.live** no se indexan por motivo nuevo **"No se ha encontrado (404)"**. A revisar en el informe de indexación de Search Console: identificar qué URLs dan 404 (¿páginas viejas/movidas, links rotos en la landing, rutas /docs?) y corregir o redirigir para que se reindexen.
