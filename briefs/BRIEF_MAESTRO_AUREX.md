...
| 🟠 **Rebrand Android → Cobrex** | 🟠 **PRÓXIMO FRENTE GRANDE** — unificar marca (hoy Android sigue "AUREX"). Ver §3.5 | Arrancar tras resolver Build 36 (no en paralelo con review Apple) | Build 36 review |
...
>
> **ORDEN ACORDADO:** 1) ✅ Web cobrex.io (hecha, 28-may) → 2) ⏳ **Rebrand Android → Cobrex**. ⚠️ **NO arrancar mientras Apple revisa el Build 36** (para no cruzar metadata/builds en revisión simultánea). Arrancar una vez que Build 36 esté resuelto.
