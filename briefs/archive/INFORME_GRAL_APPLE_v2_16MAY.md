...
> Versión: **v2** (supera v1 del 15-may)
> Fecha: 16-may-2026 02:00 AR
> Decisión: **Opción D-modificada APROBADA por Fernando**
> Autor: Code + ajustes de Escritorio + aprobación final Fernando
...
| 19+ días queue otra vez para Build 25 | Alta | Apple suele acelerar re-submits si nombre validado previamente |
