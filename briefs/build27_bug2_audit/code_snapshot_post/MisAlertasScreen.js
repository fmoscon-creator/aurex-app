          ...
          <ScrollView style={{ flex: 1 }} contentContainerStyle={{ paddingHorizontal: 14, paddingBottom: 30 }}>
            {alertas.map(a => {
              ...
              const configLine = (a.tipo === 'precio_objetivo' && a.precio_base != null)
                ? `${isUp ? '⬆️' : '⬇️'} ${isUp ? 'SUBA' : 'BAJA'} $${Math.abs(a.valor_objetivo)} desde ${fmtP(a.precio_base)}`
              ...
              return (
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={{ fontSize: 10, color: C.textDim }}>{fmtRelative(a.disparada_at || a.created_at)}</Text>
                  </View>
