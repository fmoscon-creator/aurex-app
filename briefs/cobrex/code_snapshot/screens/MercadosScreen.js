      ...
      {pulseData !== null && (
        <View style={st.pulseWrap}>
          ...
          <View style={st.pulseHeaderRow}>
            <Text style={st.pulseTitle}>{'\u26A1'} COBREX PULSE™</Text>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
            ...
            <View style={{ flex: 1 }}>
              <Text style={{ fontSize: 13, fontWeight: '700', color: pColor }} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.7}>
                {pulseEmoji(score)} {score} — {pulseLabel(score, i18n)} <Text style={{ fontSize: 8, color: C.gold, fontWeight: '700' }}>· COBREX PULSE™</Text>
              </Text>
          ...
          <Modal visible={showPulseVars} transparent animationType="fade">
            <View style={st.modalOverlay}>
              <View style={st.pulseVarsModal}>
                <ScrollView>
                  <Text style={{ fontSize: 14, fontWeight: '700', color: C.gold, marginBottom: 4 }}>⚡ COBREX FEAR & GREED 14X™</Text>
