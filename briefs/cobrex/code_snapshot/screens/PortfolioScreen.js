        ...
        <View style={st.header}>
          ...
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <View style={st.titleRow}>
              <AurexLogo size={32} />
              <Text style={st.logoText}>{BRAND_NAME}</Text>
                ...
                <ScrollView>
                  ...
                  <View style={st.shareRow}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around' }}>
                      <TouchableOpacity style={st.shareBtn} onPress={() => Linking.openURL(`mailto:?subject=Cobrex - ${detailItem.simbolo}&body=${encodeURIComponent(`${detailItem.simbolo} - $${fmt(precio)} - P&L: ${pnlP >= 0 ? '+' : ''}${fmt(pnlP,2)}% - aurex.live`)}`)}>
