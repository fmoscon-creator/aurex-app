...
import { BRAND_NAME, PRIVACY_URL, TERMS_URL } from '../lib/brand';
        ...
        return (
          <View style={st.section}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 14 }}>
              ...
              <Text style={{ fontSize: 13, fontWeight: '700', color: C.text }}>{BRAND_NAME} v{APP_VERSION} ⭐</Text>
            </View>
            <View style={{ flexDirection: 'row', gap: 16, marginTop: 8 }}>
              <TouchableOpacity onPress={() => Linking.openURL(TERMS_URL)}><Text style={{ fontSize: 11, color: '#58A6FF', textDecorationLine: 'underline' }}>{t('terminos')}</Text></TouchableOpacity>
              <TouchableOpacity onPress={() => Linking.openURL(PRIVACY_URL)}><Text style={{ fontSize: 11, color: '#58A6FF', textDecorationLine: 'underline' }}>{t('privacidad')}</Text></TouchableOpacity>
            </View>
            {/* Disclaimer */}
  ...
  return (
    <SafeAreaView style={st.container}><ScrollView>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 14, paddingTop: 10, paddingBottom: 8, borderBottomWidth: 1, borderBottomColor: '#21262D' }}>
        <AurexLogo size={32} />
        <Text style={{ fontSize: 16, fontWeight: '500', color: '#D4A017', letterSpacing: 1 }}>{BRAND_NAME}</Text>
    ...
    {showFAQ && (
      <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#000000CC', justifyContent: 'center', alignItems: 'center', zIndex: 100 }}>
        <View style={{ backgroundColor: C.card, borderRadius: 16, width: '92%', maxHeight: '85%', padding: 20, borderWidth: 1, borderColor: C.border2 }}>
          ...
          <ScrollView>
            {[
              { q: '¿Qué es Cobrex?', a: 'Cobrex es una plataforma de análisis de datos con inteligencia artificial que monitorea 350+ activos globales en tiempo real (criptomonedas, acciones, ETFs, commodities, futuros y divisas). Nuestro motor IA v7 evalúa 10 variables por activo para generar análisis estadísticos y alertas.', qen: 'What is Cobrex?', aen: 'Cobrex is an AI-powered data analytics platform that monitors 350+ global assets in real time (cryptocurrencies, stocks, ETFs, commodities, futures, and currencies). Our AI v7 engine evaluates 10 variables per asset to generate statistical analysis and alerts.' },
              ...
              { q: '¿Qué es Cobrex Pulse?', a: 'Cobrex Pulse es nuestro índice de sentimiento de mercado con 14 variables ponderadas. Va de 0 (Miedo Extremo) a 100 (Codicia Extrema). Tiene 5 filtros: Global, Cripto, Acciones, Commodities y Futuros. Incluye 3 indicadores: Cobrex Pulse, BTC Sentiment y Crypto Fear & Greed.', qen: 'What is Cobrex Pulse?', aen: 'Cobrex Pulse is our market sentiment index with 14 weighted variables. It ranges from 0 (Extreme Fear) to 100 (Extreme Greed). It has 5 filters: Global, Crypto, Stocks, Commodities, and Futures. Includes 3 indicators: Cobrex Pulse, BTC Sentiment, and Crypto Fear & Greed.' },
              ...
              { q: '¿Cómo funcionan las alertas?', a: 'Las alertas te notifican cuando: un activo alcanza tu precio objetivo, cambia el análisis IA, hay variación brusca (+/-5%), o Cobrex Pulse entra en zona extrema. Podés recibirlas por push, email o WhatsApp (según tu plan).', qen: 'How do alerts work?', aen: 'Alerts notify you when: an asset reaches your target price, the AI analysis changes, there is a sharp variation (+/-5%), or Cobrex Pulse enters an extreme zone. You can receive them via push, email, or WhatsApp (depending on your plan).' },
              { q: '¿Es confiable el análisis de Cobrex?', a: 'Cobrex es una herramienta de análisis de datos. Los análisis IA son estadísticos e informativos, no recomendaciones. Los datos de mercado son provistos por fuentes públicas. Consultá siempre a un profesional antes de tomar decisiones.', qen: 'Is Cobrex analysis reliable?', aen: 'Cobrex is a data analysis tool. AI analyses are statistical and informational, not recommendations. Market data is provided by public sources. Always consult a professional before making decisions.' },
            ].map((faq, i) => (
    ...
    {showRating && (
      <View style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: '#000000CC', justifyContent: 'center', alignItems: 'center', zIndex: 100 }}>
        <View style={{ backgroundColor: C.card, borderRadius: 16, width: '80%', padding: 24, borderWidth: 1, borderColor: C.border2, alignItems: 'center' }}>
          <Text style={{ fontSize: 18, fontWeight: '700', color: C.text, marginBottom: 6 }}>Califica Cobrex</Text>
