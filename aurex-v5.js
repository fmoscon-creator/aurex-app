...
// ═══ CALCULO LOCAL ELIMINADO ═══
// La PWA ya NO calcula senales localmente.
// FUENTE UNICA: backend Railway /api/ia-signals (calcula cada 5 min con cron)
// Funciones vacias para no romper referencias existentes:
function _fetchRSIBatch() { return Promise.resolve(); }
function _calcIAScore() { return {}; }
function _generarSenalesIALocal() { console.log('[AUREX] Calculo local ELIMINADO — solo backend'); }
function _cargarFase2() { console.log('[AUREX] Fase2 ELIMINADA — solo backend'); }

/* ═══ CODIGO ORIGINAL ELIMINADO (lineas 2259-2696) ═══
